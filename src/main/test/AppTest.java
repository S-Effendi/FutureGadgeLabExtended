...
public class AppTest {
    public static void main(String args[]) throws ParseException {
        ...
        int stat = dao.saveParking(new Parking(16160, simpleDateFormat.parse("2010-07-16 19:19:00"), simpleDateFormat.parse("2010-07-16 19:19:00"), BigDecimal.valueOf(10.50)));
